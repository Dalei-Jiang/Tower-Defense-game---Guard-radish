...
while(1):
    ...
    if mode == 0:
        os.system("python C:/Users/HAWEI/Desktop/Cabbage_Fantasy/ECE385-HelperTools-master/PNGToHex/On-Chip_Memory/scripts/png_to_txt.py")
        break
    elif mode == 1:
        os.system("python C:/Users/HAWEI/Desktop/Cabbage_Fantasy/ECE385-HelperTools-master/PNGToHex/On-Chip_Memory/scripts/png_to_3_txt.py")
        break
    elif mode == 2:
        os.system("python C:/Users/HAWEI/Desktop/Cabbage_Fantasy/ECE385-HelperTools-master/PNGToHex/On-Chip_Memory/scripts/png_to_palette_resizer.py")
        break
    elif mode == 3:
        os.system("python C:/Users/HAWEI/Desktop/Cabbage_Fantasy/ECE385-HelperTools-master/PNGToHex/On-Chip_Memory/scripts/png_to_palette_relative_resizer.py")
        break
    else:
