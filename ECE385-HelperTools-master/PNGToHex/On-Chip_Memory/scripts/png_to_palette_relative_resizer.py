...
outFile = open("C:/Users/HAWEI/Desktop/Cabbage_Fantasy/ECE385-HelperTools-master/PNGToHex/On-Chip_Memory/sprite_bytes/" + filename + '.txt', 'w')
i = 0
for y in range(im.size[1]):
    for x in range(im.size[0]):
        ...
        i += 1
outFile.close()
outImg.save("C:/Users/HAWEI/Desktop/Cabbage_Fantasy/ECE385-HelperTools-master/PNGToHex/On-Chip_Memory/sprite_converted/" + filename + ".png")
